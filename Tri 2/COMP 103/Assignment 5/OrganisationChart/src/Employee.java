...
public class Employee {
     ...
     */
    public Employee(String initials, String role, double offset, int emplNumber) {
        this.initials = initials;
        this.role = role;
        this.offset = offset;
    ...
    /** return the number of employees this person should have */
    public int getEmplNumber(){
        return emplNumber;
    }
    
    /** return persons initials */
    public String emplInitials(){
    ...
    /**
     * Returns true if this employee is managing any other employees
     */
